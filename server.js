...
【絶対禁止】以下の文字を一切使わないでください：◆◇●◎○■□▲△▼▽★☆♦♣♠♥※→←↑↓【】《》〔〕〖〗・・・（三点リーダー）など。これらを使うと文字化けが発生します。
【重要】記号が必要な場合は必ず通常のASCII文字のみ使用：- / * > < = ( ) [ ] { } ! ? . , : ;
...
【絶対禁止】以下の文字を一切使わないでください：◆◇●◎○■□▲△▼▽★☆♦♣♠♥※→←↑↓【】《》〔〕など。文字化けの原因になります。記号はASCII文字（- / * > など）のみ使用してください。
