...
セクション構成：1.冒頭注記 / 2.診断範囲・取得状況 / 3.総合リスクスコア（100点満点）＋セキュリティヘッダー チェック結果表 / 4.対象サマリー / 5.HTML分析 / 6.HTTPヘッダー分析 / 7.リスク一覧（高→中→低・各リスクに①〜⑤） / 8.優先対応ロードマップ / 9.社内確認項目 / 10.免責事項
...
7. フッターを出力しないこと（著作権表記・サイト名・バージョン情報等を含むフッター要素は一切不要）
`.trim();
